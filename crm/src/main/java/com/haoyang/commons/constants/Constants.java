package com.haoyang.commons.constants;

/**
 * @author haoyang
 * @reate 2022-07-30-18:24
 */
public class Constants {
     ...
     * 市场活动备注是否修改过
     */
    public static final String REMARK_EDIT_FLAG_FALSE = "0";
    public static final String REMARK_EDIT_FLAG_TRUE = "1";
     ...
     * Cookie存活时间十天
     */
    public static final int COOKIE_MAX_ALIVE_TIME = 10 * 24 * 60 * 60;

    /**
     * 注册账号的一些信息
     * 非锁定状态
     */
    public static final String ACT_LOCK_STATE_FALSE = "1";
    /**
     * 注册账号的一些信息
     * 锁定状态
     */
    public static final String ACT_LOCK_STATE_TRUE = "0";
