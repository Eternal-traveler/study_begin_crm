...
<script type="text/javascript">
	...
	$(function (){
		...
		$("#saveCreateActivityBtn").click(function (){
			//收集输入信息
			// 注意这里获取的是id值，在下面所有者选择栏中value值是id
		...
		// 给更新按钮添加单击事件，总的来说只是在添加上加了个查询所有数据
		...
		$.ajax({
			...
			success:function (data) {
				...
				$("#page").bs_pagination({
					...
					onChangePage: function (event,pageObj){	//return page_num and rows_per——page after a link
						//每次切换页号，调用函数
